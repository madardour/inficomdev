...
( function() {
	...
	Autocomplete.prototype = {
		...
		attach: function() {
            ...
            //Bravo
            this._listeners.push(editor.on('destroy', function () {
                this.destroy();
            }, this));
		...
		commit: function( itemId ) {
            ...
            editor.fire("personalLibraryInsert", itemId);
	...
	View.prototype = {
        ...
        /**
		 //* Creates and returns the view's search element.
		 //*
		 //* @private
		 //* @returns {CKEDITOR.dom.element}
		 //*/
        createSearchElement: function () {
            var el = new CKEDITOR.dom.element('input', this.document);
